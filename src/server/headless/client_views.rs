...
impl HeadlessServer {
    ...
    pub(super) fn handle_api_request_with_scrollback(
        ...
        let changed =
            self.handle_api_request_with_shutdown_check_inner(msg, false, false, scrollback);
    ...
    pub(super) fn handle_client_shell_api_request_with_scrollback(
        ...
        let changed =
            self.handle_api_request_with_shutdown_check_inner(msg, false, true, scrollback);
