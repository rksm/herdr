...
pub struct KeysConfig {
    ...
    /// Mark or unmark the active tab for later. Default: "prefix+m".
    pub toggle_tab_mark: BindingConfig,
    ...
    /// Toggle the agent panel between grouped and priority order. Default: "prefix+shift+a".
    pub toggle_agent_sort: BindingConfig,
...
pub(crate) struct KeysConfigOverlay {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    toggle_tab_mark: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    toggle_agent_sort: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KeysConfig {
    ...
    pub(crate) fn local_profile(&self, keybinds: &Keybinds) -> KeysConfigOverlay {
        ...
        copy_effective_action_field!(toggle_tab_mark, keybinds.toggle_tab_mark);
        ...
        copy_effective_action_field!(toggle_agent_sort, keybinds.toggle_agent_sort);
...
impl Default for KeysConfig {
    fn default() -> Self {
        Self {
            ...
            toggle_tab_mark: BindingConfig::one("prefix+m"),
            ...
            toggle_agent_sort: BindingConfig::one("prefix+shift+a"),
