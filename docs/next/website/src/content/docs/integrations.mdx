...
Claude Code integration version `8`, Codex integration version `7`, and Hermes Agent integration version `4` preserve full-permission startup mode during native restore.
